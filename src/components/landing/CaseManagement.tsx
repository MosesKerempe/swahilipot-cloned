  ...
  return (
    <section className="py-16 bg-blue-50"> {/* Dull blue background */}
      <div className="container-custom mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          <h2 className="text-3xl font-bold mb-6 text-[calc(3rem*0.8)]">Case Management Program</h2>
          <p className="text-lg text-gray-700 mb-6 text-[calc(1.125rem*0.8)]">
          ...
          <p className="text-lg text-gray-700 mb-8 text-[calc(1.125rem*0.8)]">
