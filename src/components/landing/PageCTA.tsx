  ...
  return (
    <section className="py-16 bg-gradient-to-r from-primary to-secondary text-white">
      <div className="container-custom mx-auto text-center">
        <h2 className="text-3xl font-bold mb-6 text-gray-100">Ready to Join Our Community?</h2>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link
            href="/joinus"
            className="bg-white text-primary px-6 py-3 rounded-md font-medium hover:bg-gray-200 transition-colors"
          >
            Join Us Today
          </Link>
          <Link
